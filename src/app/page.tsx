    ...
    <main>
          ...
          <div className="banner-img circle-animation relative w-[280px] h-[280px] sm:w-[320px] sm:h-[320px] md:w-[355px] md:h-[355px] rounded-full bg-white/50 flex items-center justify-center">
            ...
            <div className="tick-3d absolute flex z-10 w-[150px] sm:w-[200px] md:w-auto">
              ...
              <span className="top-right absolute right-[-15px] top-[-15px] sm:right-[-30px] sm:top-[-30px]">
                <img
                  width="42px"
                  src="/images/glass-circle.png"
                  alt=""
                  className="w-[20px] sm:w-[42px]"
                />
              </span>
      ...
      <section className="our-story-main bg-[#F8F8F8] pt-[80px] md:pt-[120px] pb-[80px] md:pb-[140px] overflow-hidden relative">
        ...
        <div className="container my-10 our-story flex flex-col md:flex-row items-center h-full gap-10 md:gap-0 relative z-10">
          {/* Left: Stats Grid */}
          <div
            className="story-left w-full md:w-[40%] grid grid-cols-2 gap-4 md:gap-6"
            data-aos="fade-right"
          >
            <div className="stat-card bg-white p-6 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 group border border-gray-100">
              <div className="text-[36px] md:text-[42px] font-bold bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent group-hover:scale-110 transition-transform origin-left">
                6+
              </div>
            ...
            <div className="stat-card bg-white p-6 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 group border border-gray-100 mt-8">
              <div className="text-[36px] md:text-[42px] font-bold bg-gradient-to-r from-purple-600 to-pink-500 bg-clip-text text-transparent group-hover:scale-110 transition-transform origin-left">
                50+
              </div>
              <p className="text-gray-600 font-medium text-sm mt-2">
                Projects Delivered
            ...
            <div className="stat-card bg-white p-6 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 group border border-gray-100">
              <div className="text-[36px] md:text-[42px] font-bold bg-gradient-to-r from-green-500 to-emerald-400 bg-clip-text text-transparent group-hover:scale-110 transition-transform origin-left">
                40+
              </div>
              <p className="text-gray-600 font-medium text-sm mt-2">
                Expert Developers
            ...
            <div className="stat-card bg-white p-6 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2 group border border-gray-100 mt-8">
              <div className="text-[36px] md:text-[42px] font-bold bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent group-hover:scale-110 transition-transform origin-left">
                98%
              </div>
              <p className="text-gray-600 font-medium text-sm mt-2">
                Client Satisfaction
          ...
          {/* Right: Content */}
          <div
            className="story-right w-full md:w-[60%] flex flex-col items-center md:items-start md:pl-[80px] lg:pl-[120px] text-center md:text-left"
            data-aos="fade-left"
          >
            ...
            <p className="text-[#555] text-[16px] md:text-[18px] font-light mb-6 leading-relaxed max-w-[600px]">
              Founded in{" "}
              <strong className="font-semibold text-black">2018</strong> and
              transitioned to an LLP in{" "}
              <strong className="font-semibold text-black">2024</strong>, Tamar
              Software has rapidly evolved into a global leader in IT solutions.
              We specialize in cutting-edge software development, AI services,
              and consultancy, serving clients across 10+ countries.
            </p>
            <p className="text-[#555] text-[16px] md:text-[18px] font-light mb-8 leading-relaxed max-w-[600px]">
              ...
              (IIT Roorkee alumnus), our team delivers excellence with passion
              and precision.
            </p>
          </div>
        </div>
      ...
      <section className="capabilities-main py-[80px] md:py-[120px] w-full bg-white overflow-hidden relative">
        ...
        <div className="container my-10">
          <div className="capabilities-header mb-12 md:mb-20 flex flex-col md:flex-row items-end justify-between gap-8">
            <div className="md:w-2/3" data-aos="fade-right">
              ...
              <p className="text-slate-600 text-[16px] md:text-[18px] font-light leading-relaxed max-w-[700px] mb-8">
                We deliver managed IT services tailored for mission-critical
                industries. From fintech to healthcare, our solutions are
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  <span
                    key={i}
                    className="px-4 py-2 bg-slate-100 text-slate-700 rounded-full text-sm font-medium border border-slate-200 hover:border-[#9428BA] hover:text-[#9428BA] hover:bg-[#9428BA]/5 transition-all cursor-default animate-fade-in-up"
            ...
            <div
              className="md:w-1/3 flex justify-start md:justify-end"
              data-aos="fade-left"
            >
              <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-white p-6 rounded-2xl shadow-xl border border-slate-700 relative overflow-hidden group">
                ...
                <div className="relative z-10 flex items-center gap-4">
                  <div className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400">
                    10+
                  </div>
          ...
          <div
            className="capabilities-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"
            data-aos="fade-up"
          >
            {[
              {
                ...
                desc: "Custom software solutions tailored to meet the unique needs of your business, ensuring efficiency and scalability.",
                icon: "💻",
              },
              {
                title: "Mobile Development",
                route: "/services/mobile-app-development",
                desc: "Create powerful and user friendly mobile applications for iOS and Android platforms.",
                icon: "📱",
              },
              {
                title: "Web Development",
                route: "/services/web-development",
                desc: "Build responsive, modern, and high-performance websites tailored to your business needs.",
                icon: "🌐",
              },
              {
                title: "AI Services",
                route: "/services/ai-services",
                desc: "Harness the power of data and artificial intelligence to drive innovation and gain a competitive edge.",
                icon: "🤖",
              },
              {
                title: "IT Consulting",
                route: "/services/it-consulting",
                desc: "Expert advice and strategic planning to help you navigate the complexities of the IT landscape and achieve your business goals.",
                icon: "💡",
              },
              {
                title: "Cybersecurity Services",
                route: "/services/cybersecurity-services",
                desc: "Expert advice and strategic planning to help you navigate the complexities of Cybersecurity and achieve your Security goals.",
                icon: "🔒",
              },
              {
                title: "Managed IT Services",
                route: "/services/managed-it-services",
                desc: "Comprehensive IT management and support services to ensure your systems run smoothly and efficiently.",
                icon: "⚙️",
              },
              {
                title: "Testing and QA Services",
                route: "/services/testing-and-qa-services",
                desc: "Rigorous testing and quality assurance processes to deliver reliable and high-performing software.",
                icon: "✓",
              },
              {
                title: "RPA Development",
                route: "/services/rpa-development",
                desc: "Streamline operations and enhance productivity with our Robotic Process Automation solutions.",
                icon: "🤖",
              },
            ].map((item, index) => (
              <Link
                href={item.route}
                key={index}
                className="capability-card group relative bg-white border border-slate-100 rounded-2xl p-8 hover:border-[#9428BA] hover:shadow-2xl transition-all duration-300 overflow-hidden flex flex-col items-start"
                data-aos="fade-up"
              ...
              >
                ...
                <h3 className="text-slate-900 text-[20px] md:text-[22px] font-bold mb-3 group-hover:text-[#9428BA] transition-colors">
                  {item.title}
                </h3>
                ...
                <div className="mt-auto flex items-center text-[#9428BA] font-semibold text-sm uppercase tracking-wider group-hover:gap-2 transition-all">
                  ...
                  <span className="text-lg leading-none ml-2 transition-transform group-hover:translate-x-1">
                    →
                  </span>
                </div>
              </Link>
      ...
      <section className="promotional-banner pt-[80px] bg-[#530722] relative overflow-hidden">
        ...
        <div className="container relative z-10 flex flex-col md:flex-row items-center md:items-end !justify-start min-h-[500px] md:min-h-[600px]">
          {/* Left Content */}
          <div
            className="content w-full md:w-[60%] lg:w-[55%] text-center md:text-left md:self-center py-20 z-20"
            data-aos="fade-right"
          >
            <h4 className="flex items-center justify-center md:justify-start gap-3 mb-6 relative">
              <span className="text-white font-serif italic text-xl md:text-2xl uppercase tracking-[0.2em] opacity-80 leading-none">
                The
              </span>
              <div className="relative inline-block">
                <span className="text-[#E31E24] font-serif italic text-5xl md:text-7xl font-bold uppercase tracking-tighter leading-none relative z-10">
                  Big
                </span>
            ...
            <p className="text-gray-300 text-[16px] md:text-[18px] leading-relaxed mb-8 max-w-[550px] mx-auto md:mx-0">
              "We don't just build software; we engineer growth. Our mission is
              to empower businesses with scalable, future-ready technology that
            ...
            <div className="person-info mb-10 mt-12 flex flex-col md:flex-row items-center md:items-start gap-4">
              ...
              <div className="text-center md:text-left">
                <h3 className="text-white text-[24px] md:text-[28px] font-bold tracking-tight mb-1">
                  Pradeep Kumar Tamar
                </h3>
                <p className="text-[#FF4D4D] text-[15px] font-medium uppercase tracking-wider opacity-90">
                  Founder & CEO, Tamar Software
                </p>
              </div>
            </div>
            ...
            <Link
              href="/about"
              className="group flex items-center justify-center md:justify-start gap-3 bg-[#E31E24] text-white px-10 py-5 rounded-[4px] font-bold transition-all hover:bg-[#c1191f] shadow-lg w-fit mx-auto md:mx-0 uppercase tracking-widest text-[14px]"
            >
              WATCH NOW
          ...
          {/* Right Image */}
          <div
            className="image w-full md:w-[40%] lg:w-[45%] flex justify-end relative items-end self-end z-10 h-full"
            data-aos="fade-left"
          >
            <div className="relative">
              <img
                src="/images/pradeep_without.png"
                alt="Pradeep Kumar Tamar"
                className="w-auto h-[450px] md:h-[650px] lg:h-[750px] object-contain drop-shadow-2xl brightness-110 pointer-events-none"
              />
        ...
        <div className="container my-10 relative z-10">
          ...
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div data-aos="fade-right" className="max-w-2xl">
              <h2 className="section-title text-[32px] md:text-[48px] font-bold text-black mb-4">
                Case Studies
              </h2>
              <p className="text-slate-600 text-lg leading-relaxed">
                Real-world success stories. See how we help enterprises
                transform challenges into digital opportunities.
              </p>
            </div>
            <Link
              href="/case-studies"
              className="hidden md:flex items-center gap-2 px-6 py-3 bg-white border border-slate-200 rounded-full text-slate-800 font-semibold hover:border-[#9428BA] hover:text-[#9428BA] transition-all shadow-sm hover:shadow-md"
              data-aos="fade-left"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Link
                key={index}
                href={item.link}
                className="case-study-card group flex flex-col bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-500 border border-slate-100"
                data-aos="fade-up"
              ...
              >
                ...
                <div className="p-8 flex flex-col flex-grow">
                  <h3 className="text-xl font-bold text-slate-900 mb-2 group-hover:text-[#9428BA] transition-colors">
                    {item.title}
                  </h3>
        ...
        <div className="container my-10 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12">
            <div data-aos="fade-right">
              <h2 className="section-title text-[28px] md:text-[40px] font-bold text-black mb-4">
                Industries We Serve
              </h2>
              <p className="text-slate-600 text-lg max-w-xl">
                Delivering specialized, high-impact digital solutions across
                diverse sectors.
              </p>
            </div>
            <Link
              href="/industries"
              className="hidden md:flex items-center gap-2 text-[#056CB7] font-semibold hover:gap-4 transition-all"
              data-aos="fade-left"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                ...
                desc: "Secure banking & fintech solutions",
              },
              {
                title: "Healthcare",
                icon: "🏥",
              ...
              },
              {
                ...
                desc: "Omnichannel e-commerce platforms",
              },
              {
                title: "Manufacturing",
                icon: "🏭",
                route: "/industries/manufacturing",
                desc: "Industry 4.0 & IoT automation",
              },
              {
                title: "Telecommunication",
                icon: "📡",
                route: "/industries/telecommunication",
                desc: "Network scaling & billing systems",
              },
              {
                title: "Education",
                icon: "🎓",
                route: "/industries/education",
                desc: "LMS & remote learning tools",
              },
              {
                title: "Government",
                icon: "🏛️",
                route: "/industries/government",
                desc: "Secure e-governance portals",
              },
            ].map((industry, index) => (
              <Link
                href={industry.route}
                key={index}
                className="industry-card bg-white rounded-xl p-6 shadow-sm border border-transparent hover:border-[#056CB7] hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group flex flex-col items-center text-center"
                data-aos="fade-up"
                data-aos-delay={index * 100}
              >
                ...
                <span className="text-[#056CB7] text-sm font-semibold opacity-0 group-hover:opacity-100 transition-opacity transform translate-y-2 group-hover:translate-y-0">
                  Explore industry →
                </span>
              </Link>
            ))}
            ...
            <Link
              href="/industries"
              className="industry-card bg-[#056CB7] rounded-xl p-6 shadow-md hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group flex flex-col items-center justify-center text-center min-h-[200px]"
              data-aos="fade-up"
              data-aos-delay="700"
            >
              ...
              <span className="w-12 h-12 rounded-full bg-white/20 flex items-center justify-center text-white text-xl mt-4 group-hover:scale-110 transition-transform">
                →
              </span>
            </Link>
          </div>
        ...
        <div className="container relative z-10">
          ...
          >
            ...
            <p className="text-slate-600 text-lg md:text-xl leading-relaxed">
              We don't just build software; we build lasting partnerships. Here
              is what our clients have to say about our impact on their
              business.
            </p>
          </div>
          ...
          <div data-aos="fade-up" data-aos-delay="200">
            <Slider
              {...testimonialSettings}
              className="testimonial-slide -mx-4 pb-12"
            >
              {[
                {
                  quote:
                    "With the help of Tamar Software, our machine automation process speed increased significantly. They always deliver software solutions before the deadline.",
                ...
                {
                  quote:
                    "The financial reconciliation system they built reduced our manual workload drastically. The accuracy and speed of the new system are unmatched.",
                ...
                {
                  quote:
                    "Their expertise in WebRTC and media streaming helped us launch our video collaboration platform in record time. Excellent engineering team.",
                ...
                {
                  quote:
                    "We needed a scalable e-commerce platform for our niche market. Tamar Software delivered a visually stunning and robust solution that our customers love.",
                ...
                <div key={index} className="px-4 h-full pt-10">
                  {" "}
                  ...
                  <div className="relative bg-white border border-slate-100 p-8 md:p-10 rounded-2xl h-full flex flex-col transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/10 hover:-translate-y-2 group hover:border-purple-200">
                    ...
                    <div
                      className={`absolute -top-6 right-8 w-12 h-12 rounded-xl bg-gradient-to-br ${item.color} flex items-center justify-center shadow-lg transform rotate-12 group-hover:rotate-0 transition-all duration-500`}
                    >
                      <span className="text-3xl text-white font-serif leading-none">
                        "
                      </span>
                    </div>
                    ...
                    <div className="mb-8 flex-grow">
                      {/* Highlight Badge */}
                      <div
                        className={`inline-block px-3 py-1 rounded-full bg-gradient-to-r ${item.color} bg-opacity-10 text-transparent bg-clip-text font-bold uppercase tracking-wide text-xs mb-6 border border-slate-200`}
                      >
                        {item.highlight}
                      </div>
                    ...
                    <div className="flex items-center gap-4 pt-6 border-t border-slate-100">
                      <div
                        className={`w-12 h-12 rounded-full bg-gradient-to-br ${item.color} flex items-center justify-center text-white font-bold text-lg shadow-md`}
                      >
                        {item.initials}
                      </div>
                      <div>
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
            ...
            <div className="w-full lg:w-1/2" data-aos="fade-right">
              <div className="section-header flex items-center gap-3 mb-8">
                <span className="icon text-[#056CB7] text-2xl">📍</span>
            ...
            <div className="w-full lg:w-1/2" data-aos="fade-left">
              ...
              <div className="contact-cards flex flex-col gap-6">
                ...
                <div className="contact-card bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-start gap-5 hover:shadow-md transition-shadow">
                  ...
                  <div>
                    <h3 className="text-[#056CB7] text-[18px] font-semibold mb-2">
                      Address
                    </h3>
                    <p className="text-[#555] text-[15px] leading-relaxed">
                      Tamar Software, LOGIX TECHNOVA, 313, Block A, Sector 132,
                ...
                <div className="contact-card bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-center gap-5 hover:shadow-md transition-shadow">
                  ...
                  <div>
                    <h3 className="text-[#056CB7] text-[18px] font-semibold mb-1">
                      Email
                    </h3>
                    <a
                      href="mailto:contact@tamarsoftware.com"
                      className="text-[#555] text-[15px] hover:text-[#056CB7] transition-colors"
                    >
