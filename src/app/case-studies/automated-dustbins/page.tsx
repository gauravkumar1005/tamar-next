...
export default function AutomatedDustbinsCaseStudy() {
    useEffect(() => {
        AOS.init({
            duration: 1000,
            once: true,
    ...
    const data = {
        ...
        subtitle: "Smart City Waste Management Solution",
        client: "Municipal Corporation",
        industry: "IoT & Smart City",
        summary: "IoT-enabled smart dustbins with real-time monitoring to optimize waste collection and reduce operational costs.",
        heroImage: "/images/dustbin-case-study1.png",
        overview: "To address the challenges of inefficient waste collection and overflowing bins in urban areas, the client sought a smart city solution. The goal was to implement technology that could monitor waste levels in real-time and optimize collection routes.",
        problem: [
            "Inefficient collection routes leading to high fuel consumption.",
            "Overflowing bins causing sanitary and environmental hazards.",
            "Lack of real-time data on waste generation patterns.",
            "High operational costs due to manual monitoring.",
        ],
        solution: "We engineered an IoT-based system where dustbins are equipped with ultrasonic sensors to detect fill levels. Data is transmitted to a central cloud dashboard via GSM/LoRaWAN, enabling dynamic route planning for collection trucks.",
        highlights: [
            "Real-time fill-level monitoring via IoT sensors.",
            "Automated alert system for collection teams.",
            "Data analytics dashboard for waste generation trends.",
            "Mobile app for workforce management and route optimization.",
        ],
        results: [
            "Reduced fuel consumption by 30% through optimized routes.",
            "Eliminated 95% of bin overflow incidents.",
            "Improved operational efficiency by 25%.",
            "Provided actionable data for future urban planning.",
        ],
        techStack: ["IoT Sensors", "Python", "MQTT", "Node.js", "React Native", "Google Maps API"],
        nextCase: "/case-studies/advanced-chatbot"
    };
