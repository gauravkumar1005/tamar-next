...
export default function PowerBIDashboardCaseStudy() {
    useEffect(() => {
        AOS.init({
            duration: 1000,
            once: true,
    ...
    const data = {
        ...
        summary: "Interactive, real-time data visualization dashboards empowering stakeholders with actionable business insights.",
        heroImage: "/images/case-studies-1.png",
        overview: "A mid-sized logistics company was struggling with data silos and delayed reporting. They needed a unified Business Intelligence (BI) solution to visualize key performance indicators (KPIs) and track fleet operations in real-time.",
        problem: [
            "Fragmented data across Excel sheets and legacy systems.",
            "Inability to track fleet efficiency and fuel costs in real-time.",
            "Delayed decision-making due to manual reporting processes.",
            "Lack of predictive insights for maintenance scheduling.",
        ],
        solution: "We implemented a comprehensive Power BI solution connecting to their SQL database and IoT sensors. We designed interactive dashboards for executive leadership and operational managers, providing drill-down capabilities into specific metrics.",
        highlights: [
            "Unified data modeling from multiple sources.",
            "Interactive, drill-down enabled Power BI reports.",
            "Automated daily report generation and email distribution.",
            "Mobile-friendly dashboard optimized for tablets.",
        ],
        results: [
            "Reduced report generation time from 3 days to instant.",
            "Identified cost-saving opportunities worth 15% of OPEX.",
            "Improved fleet utilization rates by 20%.",
            "Empowered data-driven decision making at all levels.",
        ],
        techStack: ["Power BI", "SQL Server", "Azure Data Factory", "DAX", "Python"],
        nextCase: null
    };
