          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            >
              ...
              <p className="text-xl text-slate-600 font-light mb-8 max-w-lg mx-auto lg:mx-0">
                Have a project in mind? We are here to answer your questions and
                provide world-class solutions tailored to your business needs.
              </p>
              ...
              <div className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100 hover:shadow-xl transition-shadow relative overflow-hidden group">
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:contact@Tamarsoftware.in"
                      className="text-lg font-bold text-slate-900 hover:text-purple-600 transition-colors break-words"
                    >
