...
export default function AdvancedChatbotCaseStudy() {
    useEffect(() => {
        AOS.init({
            duration: 1000,
            once: true,
    ...
    const data = {
        ...
        summary: "An intelligent, NLP-driven chatbot designed to automate customer support and enhance user engagement 24/7.",
        heroImage: "/images/case-studies-chatbot.png",
        overview: "The client, a large enterprise with high customer support volume, needed a solution to reduce wait times and handle routine queries automatically. They wanted a chatbot that could understand natural language and provide accurate, context-aware responses.",
        problem: [
            "High volume of repetitive customer queries overwhelming support staff.",
            "Long customer wait times during peak hours.",
            "Inconsistent responses from human agents.",
            "Lack of 24/7 support coverage.",
        ],
        solution: "We developed a sophisticated conversational AI bot using Natural Language Processing (NLP). The bot integrates with the client's CRM to provide personalized assistance, handle bookings, troubleshoot issues, and seamlessly hand off complex queries to human agents.",
        highlights: [
            "Context-aware conversation management using NLP.",
            "Seamless integration with existing CRM and ticketing systems.",
            "Multi-channel support (Web, WhatsApp, Messenger).",
            "Automated sentiment analysis to prioritize urgent issues.",
        ],
        results: [
            "Automated 70% of routine customer inquiries.",
            "Reduced average response time from 15 minutes to instant.",
            "Customer satisfaction score (CSAT) improved by 20%.",
            "Significant reduction in support operational costs.",
        ],
        techStack: ["Python", "TensorFlow", "NLP", "Dialogflow", "Node.js", "React"],
        nextCase: "/case-studies/online-venue-booking"
    };
