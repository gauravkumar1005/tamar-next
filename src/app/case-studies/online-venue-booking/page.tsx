...
export default function OnlineVenueBookingCaseStudy() {
    useEffect(() => {
        AOS.init({
            duration: 1000,
            once: true,
    ...
    const data = {
        ...
        subtitle: "Seamless Event Planning Platform",
        client: "Madnue Solutions",
        industry: "Hospitality",
        summary: "A comprehensive platform for discovering, comparing, and booking event venues with real-time availability.",
        heroImage: "/images/case-studies-3.png",
        overview: "Madnue Solutions aimed to digitize the traditional venue booking process. The objective was to create a user-friendly platform where customers could browse venues, check availability in real-time, and make secure bookings for weddings, conferences, and parties.",
        problem: [
            "Manual booking processes were slow and prone to double-booking errors.",
            "Lack of transparency in pricing and amenities.",
            "Customers had to physically visit multiple venues to check suitability.",
            "Inefficient calendar management for venue owners.",
        ],
        solution: "We built a robust web application featuring a powerful search engine, 360-degree virtual tours, and a real-time booking calendar. The platform provides a dual interface: one for customers to book and another for venue owners to manage listings and schedules.",
        highlights: [
            "Real-time calendar availability and sync.",
            "Interactive venue search with extensive filters.",
            "Secure online payment and deposit handling.",
            "Vendor dashboard for analytics and booking management.",
        ],
        results: [
            "Booking efficiency increased by 200%.",
            "Onboarded 100+ venues in the first launch phase.",
            "Reduced administrative overhead for venue owners by 50%.",
            "Zero double-booking incidents reported since launch.",
        ],
        techStack: ["Next.js", "Node.js", "PostgreSQL", "Stripe", "Google Maps API"],
        nextCase: "/case-studies/online-opd"
    };
