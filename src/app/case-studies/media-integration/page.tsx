...
export default function MediaIntegrationCaseStudy() {
    useEffect(() => {
        AOS.init({
            duration: 1000,
            once: true,
    ...
    const data = {
        ...
        subtitle: "Real-time Collaboration Enhancement",
        client: "Telecom Client",
        industry: "Telecommunication",
        summary: "Seamless integration of media streaming and sharing capabilities directly within voice and video calls for enhanced collaboration.",
        heroImage: "/images/case-studies-2.png",
        overview: "A leading telecom provider wanted to enhance their VoIP and video calling infrastructure. They needed a solution that would allow users to seamlessly stream high-quality media (images, videos, presentations) during live calls without latency or quality degradation.",
        problem: [
            "High latency when sharing media during active calls.",
            "Incompatibility with various codecs and file formats.",
            "Complex architecture required to synchronize streams.",
            "Poor user experience with current screen-sharing tools.",
        ],
        solution: "We engineered a custom media server solution integrated with their existing VoIP stack. The system uses adaptive bitrate streaming and real-time transcoding to ensure smooth media delivery regardless of network conditions.",
        highlights: [
            "Custom WebRTC implementation for ultra-low latency.",
            "Adaptive bitrate streaming for various network speeds.",
            "Real-time transcoding of incompatible media formats.",
            "Synchronized playback control for all call participants.",
        ],
        results: [
            "Reduced media sharing latency to <200ms.",
            "Enhanced user engagement metrics by 45%.",
            "Seamless support for 4K video sharing.",
            "Adopted by 5 major enterprise clients within 3 months.",
        ],
        techStack: ["C++", "WebRTC", "Kurento/Janus", "Node.js", "Redis"],
        nextCase: "/case-studies/automation-of-accountability"
    };
