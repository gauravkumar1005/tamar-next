...
export default function AccountabilityCaseStudy() {
    useEffect(() => {
        AOS.init({
            duration: 1000,
            once: true,
    ...
    const data = {
        ...
        subtitle: "Enterprise Financial Tracking System",
        client: "Ganesha Software",
        industry: "Fintech",
        summary: "Automated tracking for sales, purchases, and payments, significantly reducing manual errors and improving financial transparency.",
        heroImage: "/images/case-studies-2.png",
        overview: "Ganesha Software, a financial services provider, faced challenges with manual bookkeeping and reconciliation processes. They needed a digital solution to automate the tracking of sales, purchases, and payments to ensure 100% accountability and reduce human error.",
        problem: [
            "High rate of manual data entry errors.",
            "Time-consuming reconciliation of daily transactions.",
            "Lack of real-time visibility into cash flow.",
            "Difficulty in generating accurate tax reports.",
        ],
        solution: "We developed a bespoke financial automation platform that integrates with their existing ERP. The system automatically captures transaction data, performs real-time reconciliation, and flags discrepancies for review.",
        highlights: [
            "Automated data ingestion from multiple payment gateways.",
            "Real-time ledger reconciliation engine.",
            "Customizable reporting dashboard for financial audits.",
            "Role-based access control for compliance.",
        ],
        results: [
            "Achieved 99.9% accuracy in financial reporting.",
            "Reduced reconciliation time by 80%.",
            "Saved approx. 40 man-hours per week.",
            "Improved cash flow visibility for better decision making.",
        ],
        techStack: ["Java Spring Boot", "Angular", "PostgreSQL", "Apache Kafka", "Docker"],
        nextCase: "/case-studies/power-bi-dashboard"
    };
